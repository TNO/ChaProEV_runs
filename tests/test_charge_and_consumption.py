...
def test_charge_and_consumption() -> None:
    ...
    if save_interim_files:
        ...
        test_scenarios: list[str] = ['XX_bus', 'XX_van', 'XX_truck', 'XX_car']
        for scenario in test_scenarios:
            charge_drawn_by_vehicles_dataframe: pd.DataFrame = pd.read_pickle(
                f'output/{case_name}/{scenario}_'
                f'charge_drawn_by_vehicles_total.pkl'
            )
            ...
            consumption_dataframe_in_test = consumption_dataframe.loc[
                test_range
            ]
            ...
            print(
                scenario, f'{charge_drawn_in_test=}', f'{consumption_in_test=}'
            )
